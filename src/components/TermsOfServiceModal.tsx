    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between p-6 border-b border-gray-200/50 bg-white/80 backdrop-blur-sm">
          <h2 className="text-2xl font-light text-gray-900">Terms of Service</h2>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-80px)]">
          <div className="p-6 space-y-6">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">2. Client Responsibilities</h3>
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">3. Cancellation and Refund Policy</h3>
              <div className="text-gray-600 leading-relaxed text-sm space-y-2">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">4. Professional Boundaries</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">5. Limitations of Liability</h3>
              <div className="text-gray-600 leading-relaxed text-sm space-y-2">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">6. Emergency Situations</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">7. Confidentiality</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">8. Complaints and Feedback</h3>
              <div className="text-gray-600 leading-relaxed text-sm space-y-2">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">9. Service Modifications</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h3 className="text-lg font-medium text-gray-900 mb-3">11. Contact Information</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
