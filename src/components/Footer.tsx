...
const Footer = () => {
  ...
  // Reusable link styles using semantic tokens
  const linkClass =
    "text-sidebar-foreground/60 hover:text-sidebar-foreground transition-colors rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-sidebar";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sidebar-foreground/50 text-xs mt-1.5">Scan to visit</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-sidebar-foreground/60">
              <p><a href="mailto:connect@groundpath.com.au" className="hover:text-sidebar-foreground transition-colors">connect@groundpath.com.au</a></p>
              <p><a href="tel:+61410883659" className="hover:text-sidebar-foreground transition-colors">+61 410 883 659</a></p>
              <p>Perth, Western Australia</p>

              <div className="pt-2">
                <a href="https://www.linkedin.com/company/groundpath" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-sidebar-foreground transition-colors" aria-label="groundpath on LinkedIn">
                ...
                <a href="https://teams.microsoft.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-sidebar-foreground transition-colors ml-4" aria-label="Microsoft Teams">
