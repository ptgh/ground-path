...
-- Create user roles enum (without IF NOT EXISTS as it's not supported for types)
DO $$ BEGIN
    CREATE TYPE public.app_role AS ENUM ('admin', 'moderator', 'user', 'social_worker', 'mental_health_professional');
EXCEPTION
